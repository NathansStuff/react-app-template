...
import { PayBillsFrequency } from './PayBillsFrequency';
import { mockPayBillsFrequencyProps } from './PayBillsFrequency.mocks';

describe('BaseTemplate', () => {
  beforeEach(() => {
    renderRedux(<PayBillsFrequency {...mockPayBillsFrequencyProps} />);
  });
